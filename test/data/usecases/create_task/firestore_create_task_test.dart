...
void main() {
  ...
  setUp(() {
    ...
    ).thenAnswer((_) async => createdTaskId);
  });
  ...
  test('Should return the id generated by FirestoreClient', () async {
    final id = await sut.call(userId: userId, task: task);

    expect(id, createdTaskId);
  });
